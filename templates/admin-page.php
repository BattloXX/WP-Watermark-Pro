    ...
    <div class="wm-tabs">
        ...
        <div class="wm-tab-panel active" id="wm-tab-apply" role="tabpanel">
            <div class="wm-layout">
                ...
                <!-- Column 1 · Image & Watermark selection -->
                <div class="wm-col wm-col-selection">
                    ...
                    <div class="wm-box">
                        ...
                        <p class="wm-hint"><?php esc_html_e( 'Mehrfachauswahl möglich (Strg/Cmd halten).', 'watermark-pro' ); ?></p>
                    </div>
                    ...
                    <div class="wm-box">
                        ...
                        <div id="wm-image-wm-settings">
                            ...
                            <button id="wm-btn-select-wm" class="button button-secondary wm-btn-select">
                                ...
                                <?php esc_html_e( 'Wasserzeichen aus Mediathek wählen', 'watermark-pro' ); ?>
                            </button>
                            <p class="wm-hint"><?php esc_html_e( 'PNG (empfohlen), JPG, WebP, GIF oder EPS.', 'watermark-pro' ); ?>
                                <?php if ( ! extension_loaded( 'imagick' ) ) : ?>
                                    <em style="color:#d63638"><?php esc_html_e( ' EPS: Imagick nicht installiert.', 'watermark-pro' ); ?></em>
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                ...
                <div class="wm-col wm-col-settings">
                    <div class="wm-box">
                        ...
                        <div class="wm-field">
                            ...
                            <div class="wm-row">
                                <select id="wm-template-select" style="flex:1">
                        ...
                        <div id="wm-image-wm-controls">
                            ...
                            <p class="wm-section-label"><?php esc_html_e( 'Bild-Wasserzeichen', 'watermark-pro' ); ?></p>
                        ...
                        <div class="wm-field">
                            <label class="wm-toggle-label">
                                ...
                                <strong><?php esc_html_e( 'Text-Wasserzeichen', 'watermark-pro' ); ?></strong>
                            </label>
                        ...
                        <div id="wm-text-settings" style="display:none">
                            ...
                            <div class="wm-field">
                                ...
                                <select id="wm-text-position" class="widefat">
                                    ...
                                    <optgroup label="<?php esc_attr_e( 'Bildrand', 'watermark-pro' ); ?>">
                                        ...
                                        <option value="edge-left"><?php   esc_html_e( 'Linker Rand (gedreht ↺ CCW)',    'watermark-pro' ); ?></option>
                                        <option value="edge-right"><?php  esc_html_e( 'Rechter Rand (gedreht ↻ CW)',   'watermark-pro' ); ?></option>
                                    </optgroup>
                                </select>
                            </div>

                            <div class="wm-field">
                                <label for="wm-text-align"><?php esc_html_e( 'Ausrichtung', 'watermark-pro' ); ?></label>
                            ...
                            <div class="wm-field">
                                ...
                                <div class="wm-row">
                                    <input type="color" id="wm-text-color" value="#ffffff" style="width:44px;height:34px;padding:2px;cursor:pointer">
                                    <input type="range" id="wm-text-opacity" min="10" max="100" value="80" class="wm-slider" style="flex:1">
                                    <strong><span id="wm-text-opacity-val">80</span>%</strong>
                                </div>
                            </div>
                            ...
                            <p class="wm-hint"><?php esc_html_e( 'Vorschau zeigt Systemschrift; der Server verwendet die gewählte TTF-Schrift.', 'watermark-pro' ); ?></p>
